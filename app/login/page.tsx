    ...
    <div className="relative flex min-h-screen overflow-hidden bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
      ...
      >
        ...
        <p className="max-w-md mt-4 leading-relaxed text-gray-600">
          Advanced clinical intelligence platform built for ICU monitoring,
          medication safety, and enterprise-grade hospital systems.
        </p>

        <div className="mt-10 space-y-6">
          <Feature icon={<Activity />} text="Real-time ICU monitoring" />
          <Feature icon={<ShieldCheck />} text="Automated risk detection" />
          <Feature icon={<UserCog />} text="Role-based access control" />
        </div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <p className="mt-6 text-xs text-center text-gray-400">
            Enterprise simulation • Role-based system
          </p>
        </motion.div>
      </motion.div>
    </div>
