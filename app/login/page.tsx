    ...
    <div className="relative flex min-h-screen overflow-hidden bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
      ...
      >
        ...
        <p className="max-w-md mt-4 leading-relaxed text-gray-600">
          Enterprise clinical intelligence platform for ICU monitoring,
          medication safety, and real-time hospital alerts.
        </p>
      ...
      >
        ...
        >
          ...
          <p className="mt-2 text-sm text-center text-gray-500">
            Secure clinical dashboard access
          </p>
          ...
          <p className="mt-6 text-xs text-center text-gray-400">
            Enterprise simulation • Role-based access
          </p>
        </motion.div>
      </motion.div>
    </div>
