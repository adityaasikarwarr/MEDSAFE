...
Real-time ICU monitoring, medication safety detection,
automated clinical alerts, and hospital analytics —
...
MedSafe AI is a clinical intelligence platform designed
to enhance hospital monitoring through real-time patient
tracking, automated alerts, and advanced analytics.
...
<footer className="relative overflow-hidden text-white bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-500">

<div className="absolute inset-0 opacity-40">

<div className="absolute w-[500px] h-[500px] bg-white/20 blur-[120px] -top-40 -left-40 rounded-full" />

<div className="absolute w-[400px] h-[400px] bg-white/20 blur-[120px] bottom-[-120px] right-[-120px] rounded-full" />
...
AI-powered clinical monitoring platform helping hospitals
detect risks earlier and improve patient safety.
...
<div className="flex flex-col items-center justify-between pt-6 mt-16 text-sm text-blue-100 border-t border-white/20 md:flex-row">

<p>
© {new Date().getFullYear()} MedSafe AI
</p>
